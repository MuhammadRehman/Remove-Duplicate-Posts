...
function rdp_admin_scripts_styles() {
    wp_enqueue_style( 'rdp-admin-style', RDP_PLUGIN_URL . 'assets/css/style.css', array(), '1.1' );
    wp_enqueue_script( 'rdp-admin-script', RDP_PLUGIN_URL . 'assets/js/rdp-script.js', array('jquery'), '1.1' );
}
